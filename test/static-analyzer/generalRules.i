...
# 5 "src/generalRules.c" 2



# 7 "src/generalRules.c"
void rule_1_2_a(Rule rule, RuleContext context) {
...
void rule_1_3_b(Rule rule, RuleContext context) {
    uint64_t *braceStack = 
# 25 "src/generalRules.c" 3 4
                          ((void *)0)
# 25 "src/generalRules.c"
                              ;
